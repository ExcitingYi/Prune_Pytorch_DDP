...
python prune.py --data_root data --model vgg16 --dataset cifar10 \
    ...
    --lr_decay_milestones 40,70,90 --log_tag example --prune_type filter_prune \
    --weight_file ./checkpoints/scratch/cifar10_vgg16_scratch_ddp-example.pth --retrain_epoch 50 \
    --config_file ./prune_config/vgg16_cifar10_filter.yaml --prune_freq 5 \
    --ip 127.0.0.34 --port 23456
